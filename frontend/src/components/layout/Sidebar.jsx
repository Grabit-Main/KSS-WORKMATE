...
export const Sidebar = () => {
  ...
  const links = [
    { to: '/', icon: <LayoutDashboard size={20} />, label: 'Dashboard', roles: ['CEO', 'CTO', 'PM', 'TL', 'TM'] },
    { to: '/projects', icon: <Folders size={20} />, label: 'Projects', roles: ['CEO', 'CTO', 'PM', 'TL', 'TM'] },
    { to: '/tasks', icon: <CheckSquare size={20} />, label: 'Tasks', roles: ['CEO', 'CTO', 'PM', 'TL', 'TM'] },
    { to: '/reviews', icon: <Star size={20} />, label: 'Reviews', roles: ['CEO', 'CTO', 'PM', 'TL', 'TM'] },
  ];
  ...
  return (
    <aside style={{
      ...
      <div style={{ padding: '24px', display: 'flex', alignItems: 'center', gap: '12px' }}>
        <img src="/logo.webp" alt="Workmate" style={{ height: '32px' }} />
        <span className="font-bold text-lg" style={{ color: 'var(--brand-600)' }}>Workmate</span>
      </div>
