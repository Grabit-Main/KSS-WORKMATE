...
<body style="font-family: Inter, sans-serif; background: #f8f9fc; padding: 40px;">
  <div style="max-width:480px;margin:0 auto;background:#fff;border-radius:16px;padding:40px;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
    <img src="https://kss_workmate.vercel.app/logo.webp" alt="Workmate" style="height:40px;margin-bottom:24px;" />
    <h2 style="color:#18181B;margin:0 0 8px;">Password Reset OTP</h2>
    <p style="color:#52525B;margin:0 0 24px;">Use the code below to reset your Workmate password. It expires in <strong>10 minutes</strong>.</p>
...
def send_otp_email(to_email: str, otp: str):
    resend.Emails.send({
        ...
        "to": [to_email],
        "subject": "Your Workmate OTP Code",
